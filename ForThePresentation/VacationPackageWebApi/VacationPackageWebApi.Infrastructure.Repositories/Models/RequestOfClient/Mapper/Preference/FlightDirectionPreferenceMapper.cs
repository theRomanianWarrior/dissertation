...
{
    public static FlightDirectionPreference ToEntity(this FlightDirectionPreferenceDto flightDirectionPreferenceDto,
        FlightPreference departureFlightPreference, FlightPreference returnFlightPreference)
    {
