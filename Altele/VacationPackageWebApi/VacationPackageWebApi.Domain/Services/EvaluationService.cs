...
public class EvaluationService : IEvaluationService
{
    public void CalculateEvaluationRatings(ref ServiceEvaluationDto evaluationOfServices)
    {
        ...
        evaluationOfServices.PropertyEvaluation.FinalPropertyRating =
            CalculatePropertyEvaluationRating(evaluationOfServices.PropertyEvaluation);

        evaluationOfServices.AttractionEvaluation.FinalAttractionEvaluation =
            CalculateAttractionEvaluationRating(evaluationOfServices.AttractionEvaluation.AttractionEvaluations);
    }
    ...
    {
        return ((float) Convert.ToInt16(propertyEvaluation.Amenities) + Convert.ToInt16(propertyEvaluation.PlaceType) +
                Convert.ToInt16(propertyEvaluation.PropertyType) +
