...
namespace VacationPackageWebApi.Application.Services
{
    public class PreferencesPackageService : IPreferencesPackageService
    {
        ...
        public PreferencesPackageService(IAgentService agentService, IPreferencesPackageRequestRepository preferencesPackageRepository, IRecommendationService recommendationService, IEvaluationService evaluationService)
        {
