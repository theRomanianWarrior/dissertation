...
{
    public static FlightDirectionEvaluation ToEntity(this FlightDirectionEvaluationDto flightDirectionEvaluation, Guid departureFlightEvaluationId, Guid returnFlightEvaluationId)
    {
